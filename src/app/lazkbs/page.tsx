      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            ...
            <a href="#contact" className="bg-orange-600 text-white px-5 py-2.5 rounded-full font-medium hover:bg-orange-700 transition shadow-lg shadow-orange-600/20">
              Hubungi Kami
            </a>
          </div>
...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      desc: "Perencanaan desain rumah, kantor, dan bangunan komersial yang fungsional dan estetis."
    },
    {
      icon: <Icons.MapPin />,
